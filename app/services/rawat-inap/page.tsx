  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4">
        <Link
          href="/"
          className="flex items-center gap-2 text-[#015A85] hover:text-[#0009ad] mb-8"
        >
          <ArrowLeft size={20} />
          Kembali ke Beranda
        </Link>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-4xl font-bold text-[#0009ad] mb-4">Rawat Inap</h1>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50 p-4 rounded-lg">
              <h3 className="font-semibold text-[#0009ad] mb-2">Fasilitas</h3>
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              <h3 className="font-semibold text-[#0009ad] mb-2">
                Pendampingan
              </h3>
              <ul className="text-sm text-gray-700 space-y-1">
