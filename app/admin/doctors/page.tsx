      ...
      <div className="max-w-[1220px] mx-auto px-4 md:px-8 py-8">
        <div className="flex justify-between items-center mb-8">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-green-600 text-white px-6 py-3 rounded-lg hover:[#1c2180] transition-colors cursor-pointer"
          >
            <Plus size={20} />
            Tambah Dokter
          </button>
                  ...
                  <tr key={doctor.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 flex gap-2">
                      <button
                        ...
                        className="p-2 text-[#1c2180] hover:bg-blue-50 rounded-lg transition-colors"
                      >
                        <Edit2 size={18} />
                      </button>
                      <button
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-4">
                  ...
                  <label htmlFor="doctor-image" className="cursor-pointer">
                    <div className="mt-2 text-center text-sm text-[#1c2180] hover:text-[#1c2180]">
                      Pilih Foto
                    </div>
                  </label>
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1c2180] outline-none"
                  required
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-[#1c2180] text-white py-3 rounded-lg hover:bg-[#1c2180] transition-colors font-semibold mt-6"
              >
