                  ...
                  <tr key={doctor.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 flex gap-2">
                      <button
                        ...
                        className="p-2 text-[#005075] hover:bg-blue-50 rounded-lg transition-colors"
                      >
                        <Edit2 size={18} />
                      </button>
                      <button
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-4">
                  ...
                  <label htmlFor="doctor-image" className="cursor-pointer">
                    <div className="mt-2 text-center text-sm text-[#005075] hover:text-[#005075]">
                      Pilih Foto
                    </div>
                  </label>
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#005075] outline-none"
                  required
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-[#005075] text-white py-3 rounded-lg hover:bg-[#005075] transition-colors font-semibold mt-6"
              >
