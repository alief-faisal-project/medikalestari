      ...
      <div className="max-w-[1220px] mx-auto px-4 md:px-8 py-8">
        <div className="flex justify-between items-center mb-8">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-green-600 text-white px-6 py-3 rounded-lg hover:[#007AFF] transition-colors cursor-pointer"
          >
            <Plus size={20} />
            Tambah Dokter
          </button>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-4">
                  ...
                  <label htmlFor="doctor-image" className="cursor-pointer">
                    <div className="mt-2 text-center text-sm text-[#007AFF] hover:text-[#007AFF]">
                      Pilih Foto
                    </div>
                  </label>
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#007AFF] outline-none"
                  required
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-[#007AFF] text-white py-3 rounded-lg hover:bg-[#007AFF] transition-colors font-semibold mt-6"
              >
