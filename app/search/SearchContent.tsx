                  ...
                  {searchResults.map((doctor) => (
                    ...
                    >
                      <Link href={`/dokter/${doctor.id}`}>
                        <div className="group flex gap-3 p-4 bg-white rounded-lg md:rounded-xl border border-gray-200 hover:border-[#007AFF] hover:shadow-md transition-all cursor-pointer md:p-5">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="text-sm md:text-lg font-bold text-gray-900 group-hover:text-[#007AFF] transition-colors line-clamp-1">
                              {doctor.name}
                            </h3>
                            <p className="text-xs md:text-sm text-[#007AFF] font-semibold mb-1 md:mb-2">
                              {doctor.specialty}
                            </p>
                          ...
                          <div className="flex-shrink-0 flex items-center">
                            <div className="px-3 md:px-4 py-2 bg-[#007AFF] text-white rounded-lg font-semibold text-xs md:text-sm hover:bg-[#0055A4] transition-colors">
                              Lihat
                            </div>
                          </div>
                        </div>
              ...
              <div className="space-y-3">
                    ...
                    >
                      ...
                      >
                        <button
                          ...
                          className="px-3 md:px-4 py-2 bg-gradient-to-r from-blue-50 to-cyan-50 hover:from-blue-100 hover:to-cyan-100 border border-blue-200 hover:border-blue-300 rounded-full text-xs md:text-sm font-medium text-gray-700 hover:text-[#007AFF] transition-all whitespace-nowrap"
                        >
                          {category}
                        </button>
                      </Link>
                ...
                {randomCategories.length > 10 && (
                  <motion.button
                    ...
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="w-full flex items-center justify-center gap-2 py-3 text-[#007AFF] font-semibold text-sm hover:bg-blue-50 rounded-lg transition-colors"
                  >
                    <span>
