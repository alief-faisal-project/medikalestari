      ...
      <main className="max-w-[1175px] mx-auto px-6 md:px-8 py-12">
        ...
        <div className="flex flex-row items-center justify-between py-10 border-t border-slate-100 gap-4">
          ...
          <a
            ...
            target="_blank"
            className="inline-flex items-center gap-2 px-4 py-3 bg-[#007AFF] text-white text-[11px] sm:text-sm font-semibold rounded-lg hover:bg-[#007AFF]/90 transition-all hover:scale-95 shrink-0"
          >
