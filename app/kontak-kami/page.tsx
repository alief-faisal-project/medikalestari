...
const KontakKami = () => {
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-[#1c2180] relative overflow-hidden pb-20">
      ...
      <div className="relative z-10 max-w-[1175px] mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-slate-200 p-3 text-sm focus:border-[#1c2180] outline-none"
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full bg-white border border-slate-200 p-3 text-sm focus:border-[#1c2180] outline-none resize-none"
              ...
              <button
                type="submit"
                className="bg-[#1c2180] text-white px-8 py-4 text-xs font-bold uppercase hover:bg-[#1c2180]/90 transition-all flex items-center gap-3 cursor-pointer hover:scale-95"
              >
          ...
          <div className="lg:col-span-5">
            <div className="bg-[#1c2180] text-white p-10 shadow-2xl relative overflow-hidden">
