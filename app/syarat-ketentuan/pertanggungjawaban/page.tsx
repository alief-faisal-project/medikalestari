      ...
      <section className="py-12 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="space-y-12">
            {/* Tanggung Jawab RS */}
            <div>
              <h2 className="text-3xl font-bold text-[#004a8c] mb-6 pb-4 border-b-2 border-[#0059FF]">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-8 w-8 rounded-full bg-[#0059FF] text-white font-bold">
                      1
                    </div>
                  </div>
                  <div className="ml-4">
