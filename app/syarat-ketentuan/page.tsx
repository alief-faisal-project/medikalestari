...
const SyaratKetentuan = () => {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Header Section */}
      <section className="bg-gradient-to-r from-[#004a8c] to-[#006adb] text-white py-12 px-6">
      ...
      <section className="py-12 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="grid gap-6">
            {sections.map((section) => (
              <Link key={section.id} href={section.href}>
                <div className="p-6 border border-gray-200 rounded-lg hover:shadow-lg hover:border-[#006adb] transition-all cursor-pointer group">
                  <h3 className="text-xl font-bold text-[#004a8c] group-hover:text-[#006adb] mb-2">
                    {section.title}
                  </h3>
                  <p className="text-gray-600">{section.content}</p>
                  <div className="flex items-center mt-4 text-[#006adb] font-semibold">
                    Baca Selengkapnya
                    <svg
          ...
          {/* Summary Section */}
          <div className="mt-12 p-6 bg-blue-50 border-l-4 border-[#006adb] rounded">
            <h3 className="text-lg font-bold text-[#004a8c] mb-4">
              Ringkasan Penting
            </h3>
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-start">
                <span className="text-[#006adb] font-bold mr-3">✓</span>
                <span>
