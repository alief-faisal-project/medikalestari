        ...
        {recommendedDoctors.map((doctor) => (
          <motion.div key={doctor.id} variants={itemVariants}>
            <Link href={`/dokter/${doctor.id}`}>
              <div className="group flex items-center p-3 bg-white border border-slate-100 rounded-xl hover:border-blue-200 hover:shadow-md hover:shadow-[#005cb3] transition-all duration-200 -mt-2">
                ...
                {/* Arrow Icon */}
                <div className="ml-2 text-slate-300 group-hover:text-[#005cb3] transition-colors">
                  <svg
