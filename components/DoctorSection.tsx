              ...
              <div className="flex-1 text-left">
                ...
                <div className="flex flex-wrap justify-start gap-2 md:gap-3">
                  <button
                    ...
                    className="px-4 py-2 md:px-8 md:py-3 bg-[#0009ad] text-white text-[10px] md:text-[12px] font-bold rounded-full transition-all hover:bg-[#0009ad]/90 active:scale-95 shadow-md shadow-blue-900/5 cursor-pointer"
                  >
                    Buat Janji Temu
                  </button>
                  <Link
                ...
                {new Array(totalPages).fill(null).map((_, i) => (
                  <button
                    ...
                    className={`w-11 h-11 flex items-center justify-center rounded-none font-bold text-xs transition-all ${
                      currentPage === i + 1
                        ? "bg-[#0009ad] text-white border border-[#0009ad]"
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <aside className="w-full lg:w-1/3 xl:w-1/4 lg:sticky lg:top-45 z-30">
            <div className="border border-slate-200 p-8 bg-white rounded-none shadow-sm h-fit">
              <div className="flex items-center gap-3 mb-8 text-[#0009ad] border-b border-slate-50 pb-4">
                <FilterIcon size={18} />
              ...
              <div className="mb-6">
                <label
                  htmlFor="doctor-name"
                  className="block text-sm font-bold text-[#0009ad] mb-2"
                >
                  Nama Dokter
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full border-b border-slate-200 py-2 pl-7 outline-none focus:border-[#0009ad] text-sm bg-transparent rounded-none"
                  />
                </div>
              </div>
              ...
              <button
                ...
                className="w-full bg-[#0009ad] text-white py-4 font-bold rounded-full cursor-pointer transition-all hover:bg-[#0009ad]/90 active:scale-[0.98]"
              >
