...
const NavbarClient: React.FC<NavbarClientProps> = ({ logoNode }) => {
  ...
  return (
    <nav className="w-full font-sans sticky top-0 z-[100] bg-white shadow-sm">
      ...
      <div className="bg-white py-2 relative z-[101]">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-4 items-center text-[15px] font-normal text-gray-700">
            <Link
              href="/kontak-kami"
              className="hover:text-[#0045C9] hover:underline"
            >
              Kontak
            </Link>
      ...
      {/* --- Bottom Navbar --- */}
      <div className="hidden md:block relative w-full bg-[#0059FF] text-white z-30">
        <div
          className="absolute right-0 top-0 h-full w-[38%] bg-[#0045C9] hidden lg:block"
          ...
          <>
            ...
            >
              <div className="flex flex-col p-4">
                <button
                  onClick={handleHomeClick}
                  className="text-left p-4 font-bold text-[#0059FF] border-b text-lg"
                >
                  Beranda
                </button>
                          ...
                          {menuData[item].map((subitem) => {
                            ...
                            return (
                              <Link
                                ...
                                className="block p-4 pl-8 text-gray-600 border-b text-sm hover:bg-blue-50 hover:text-[#0045C9] transition-colors"
                              >
                                {subitem}
                              </Link>
                            );
    ...
    return (
      <Link
        ...
        className={`flex items-center gap-2 font-medium ${
          isMobile ? "text-[#0059FF] text-sm" : "text-white text-sm "
        }`}
        title="Panel Admin"
      >
